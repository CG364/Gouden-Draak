...
@section('page-title', 'New dish')

@section('content')
<form method="POST" action="{{ route('admin.dishes.store') }}" class="space-y-6 max-w-3xl">
    @csrf
    ...
    <div class="flex gap-3">
        ...
        <a href="{{ route('admin.dishes.index') }}" class="rounded px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100">
            Cancel
        </a>
    </div>
</form>
